...
//                                     alert(JSON.stringify(data));
                   ...
                   if(scval=='UPS'){
                   var url ='http://getappco.de/shop_app/stripe/cart_ios.php?C_Name='+$scope.add.userName+'&C_Mail='+useremail+'&Total_Items='+cartitemsarr.length+'&Items_Name='+productarr+'&Items_Price='+pricearr+'&Items_Qty='+quantityarr+'&Items_Tax='+taxarr+'&Image='+imagearr+'&oths='+JSON.stringify(arr)+'&type='+JSON.stringify(scarr)+'&Seller=333 place St.,City,AL,36000&Buyer='+$scope.add.address+','+$scope.add.selectedcity+','+$scope.add.selectedstate+','+$scope.add.pincode;
                   }
                   else if(scval=='BS'){
                   var url ='http://getappco.de/shop_app/stripe/cart_ios.php?C_Name='+$scope.add.userName+'&C_Mail='+useremail+'&Total_Items='+cartitemsarr.length+'&Items_Name='+productarr+'&Items_Price='+pricearr+'&Items_Qty='+quantityarr+'&Items_Tax='+taxarr+'&Image='+imagearr+'&oths='+JSON.stringify(arr)+'&type=BS&Seller=333 place St.,City,AL,36000&Buyer='+$scope.add.address+','+$scope.add.selectedcity+','+$scope.add.selectedstate+','+$scope.add.pincode;
                   }
                   else{
                   var url ='http://getappco.de/shop_app/stripe/cart_ios.php?C_Name='+$scope.add.userName+'&C_Mail='+useremail+'&Total_Items='+cartitemsarr.length+'&Items_Name='+productarr+'&Items_Price='+pricearr+'&Items_Qty='+quantityarr+'&Items_Tax='+taxarr+'&Image='+imagearr+'&oths='+JSON.stringify(arr)+'&type='+scval+'&Seller=333 place St.,City,AL,36000&Buyer='+$scope.add.address+','+$scope.add.selectedcity+','+$scope.add.selectedstate+','+$scope.add.pincode;
                   }
