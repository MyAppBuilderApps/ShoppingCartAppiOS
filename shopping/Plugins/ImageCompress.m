...
- (void)imageCompress:(CDVInvokedUrlCommand*)command
{
    ...
    if (inwidth.length!=0)
    {
       ...
       /* UIImage *tempImage = nil;
        ...
        [image drawInRect:thumbnailRect blendMode:kCGBlendModeNormal alpha:1.0];
        tempImage = UIGraphicsGetImageFromCurrentImageContext();
        UIGraphicsEndImageContext();
        UIImage *imageg = [UIImage imageWithCGImage:tempImage.CGImage scale:1.0 orientation:UIImageOrientationUp];
        
        
        UIImageView *imageView = [[UIImageView alloc] initWithImage:imageg];
        
        imageView.contentMode = UIViewContentModeTopRight;*/
        
        int maxWidth = [inwidth integerValue];
        int maxHeight = [inHeight integerValue];
        UIImage *imageCopy;
        
        if (maxHeight==57||maxWidth==57)
        {
            
            CGSize targetSize = CGSizeMake(57,57);
            UIGraphicsBeginImageContext(targetSize);
        ...
        NSData* datas = UIImageJPEGRepresentation(imageCopy,0.8);
...
-(void)myappBuilderImageUpload :(NSData *)imageData
{
    ...
    else if([getCountFrominArrayValues isEqualToString:@"3"])
    {
        ...
        NSArray *arrayOfComponents_descriptionValues = [description_Values componentsSeparatedByCharactersInSet:characterSet];
        // Create string from the array components
...
NSString *description_titles_Values =[arrayOfComponents_descriptionValues componentsJoinedByString:@""];
    ...
    {
        //Titles
        /*NSString *descriptionValues = [NSString stringWithFormat:@"%@",Values[1]];
         NSString *descriptionKeys =  [NSString stringWithFormat:@"%@",keys[1]];
         //Submenu
         NSString *submenuValues = [NSString stringWithFormat:@"%@",Values[2]];
         NSString *submenuKeys = [NSString stringWithFormat:@"%@",keys[2]];
         //subdomain
         NSString *subdomainValues = [NSString stringWithFormat:@"%@",Values[3]];
         NSString *subdomainKeys = [NSString stringWithFormat:@"%@",keys[3]];
         ...
         NSArray *keySpaceValue = [keys[4] componentsSeparatedByString:@"\n"];
         NSArray *keyRemove = [keys[0] componentsSeparatedByString:@"\""];
         NSArray *descriptionArray = [descriptionValues componentsSeparatedByString:@"\""];
         NSArray *titles_Array = [Values[4] componentsSeparatedByString:@"\""];
         ...
         {
         title_string = [Values[4] stringByAddingPercentEscapesUsingEncoding:NSASCIIStringEncoding];
         }
         if(descriptionArray.count>1)
         {
         descriptio_String = [descriptionArray[1] stringByAddingPercentEscapesUsingEncoding:NSASCIIStringEncoding];
    ...
    else if([getCountFrominArrayValues isEqualToString:@"6"])
    {
        ...
        /* NSString *descriptionValues = [NSString stringWithFormat:@"%@",Values[1]];
         NSString *descriptionKeys =  [NSString stringWithFormat:@"%@",keys[1]];
         //Submenu
         NSString *submenuValues = [NSString stringWithFormat:@"%@",Values[3]];
         NSString *submenuKeys = [NSString stringWithFormat:@"%@",keys[3]];
         //subdomain
         NSString *subdomainValues = [NSString stringWithFormat:@"%@",Values[4]];
         NSString *subdomainKeys = [NSString stringWithFormat:@"%@",keys[4]];
         //domain
         NSString *domainValues = [NSString stringWithFormat:@"%@",Values[2]];
         NSString *domainKeys = [NSString stringWithFormat:@"%@",keys[2]];
         
         NSArray *keySpaceValue = [keys[5] componentsSeparatedByString:@"\n"];
         NSArray *keyRemove = [keys[0] componentsSeparatedByString:@"\""];
         
         
         NSArray *descriptionArray = [descriptionValues componentsSeparatedByString:@"\""];
         NSArray *titles_Array = [Values[5] componentsSeparatedByString:@"\""];
         NSArray *submenuValues_Array = [submenuValues componentsSeparatedByString:@"\""];
         NSArray *subdomainValues_Array = [subdomainValues componentsSeparatedByString:@"\""];
         ...
         {
         //title_string = [Values[5]];
         title_string = [NSString stringWithFormat:@"%@",Values[5]];
         }
         if(descriptionArray.count>1)
         {
         descriptio_String = [descriptionArray[1] stringByAddingPercentEscapesUsingEncoding:NSASCIIStringEncoding];
         ...
         //Key Remove Col
         NSArray *keySpaceValue_key = [keySpaceValue[1] componentsSeparatedByString:@"\""];
         NSString *keySpaceValue_keyString;
         if (keySpaceValue_key.count>0)
         {
         keySpaceValue_keyString = [NSString stringWithFormat:@"%@",keySpaceValue_key[1]];
         }
         else
         {
         keySpaceValue_keyString = [NSString stringWithFormat:@"%@",keySpaceValue[1]];
         }
         
         NSArray *keySpaceValue_key1 = [descriptionKeys componentsSeparatedByString:@"\""];
         NSString *keySpaceValue_keyString1;
         if (keySpaceValue_key1.count>0)
         {
         keySpaceValue_keyString1 = [NSString stringWithFormat:@"%@",keySpaceValue_key1[1]];
         }
         else
         {
         keySpaceValue_keyString1 = [NSString stringWithFormat:@"%@",descriptionKeys];
         }
         
         NSArray *keySpaceValue_key2 = [submenuKeys componentsSeparatedByString:@"\""];
         NSString *keySpaceValue_keyString2;
         if (keySpaceValue_key2.count>0)
         {
         keySpaceValue_keyString2 = [NSString stringWithFormat:@"%@",keySpaceValue_key2[1]];
         }
         else
         {
         keySpaceValue_keyString2 = [NSString stringWithFormat:@"%@",submenuKeys];
         }
         
         NSArray *keySpaceValue_key3 = [subdomainKeys componentsSeparatedByString:@"\""];
         NSString *keySpaceValue_keyString3;
         if (keySpaceValue_key3.count>0)
         {
         keySpaceValue_keyString3 = [NSString stringWithFormat:@"%@",keySpaceValue_key3[1]];
         }
         else
         {
         keySpaceValue_keyString3 = [NSString stringWithFormat:@"%@",subdomainKeys];
         }
         
         NSArray *keySpaceValue_key4 = [domainKeys componentsSeparatedByString:@"\""];
         NSString *keySpaceValue_keyString4;
         if (keySpaceValue_key3.count>0)
         {
         keySpaceValue_keyString4 = [NSString stringWithFormat:@"%@",keySpaceValue_key4[1]];
         }
         else
         {
         keySpaceValue_keyString4 = [NSString stringWithFormat:@"%@",domainKeys];
         }
         
         
         
         
         NSLog(@"Key Colons:%@",keySpaceValue_keyString);
         NSLog(@"Key Colons2:%@",keySpaceValue_keyString1);
         NSLog(@"Key Colons3:%@",keySpaceValue_keyString2);
         NSLog(@"Key Colons3:%@",keySpaceValue_keyString3);
         NSLog(@"Key Colons4:%@",keySpaceValue_keyString4);
         
         urlValueGetHere = [NSString stringWithFormat:@"%@%@=%@&%@=%@&%@=%@&%@=%@&%@=%@&%@=%@",inURLValues,keyRemove[1],Values[0],keySpaceValue_keyString,title_string,keySpaceValue_keyString1,descriptio_String,keySpaceValue_keyString2,submenuValues_String,keySpaceValue_keyString3,subdomainValues_String,keySpaceValue_keyString4,domainValues_String];
         NSArray* words = [urlValueGetHere componentsSeparatedByCharactersInSet :[NSCharacterSet whitespaceCharacterSet]];
         nospacestring = [words componentsJoinedByString:@""];
         NSArray *wordsRemoveSpace = [nospacestring componentsSeparatedByCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
         spaceStringRemoved  = [wordsRemoveSpace componentsJoinedByString:@""];
    ...
    {
        //Titles
        NSString *descriptionKeys =  [NSString stringWithFormat:@"%@",keys[3]];
        NSString *descriptionValues = [NSString stringWithFormat:@"%@",Values[3]];
        //Submenu
        NSString *submenuKeys = [NSString stringWithFormat:@"%@",keys[5]];
        NSString *submenuValues = [NSString stringWithFormat:@"%@",Values[5]];
        //subdomain
        NSString *subdomainKeys = [NSString stringWithFormat:@"%@",keys[6]];
        NSString *subdomainValues = [NSString stringWithFormat:@"%@",Values[6]];
        //domain
        NSString *domainKeys = [NSString stringWithFormat:@"%@",keys[4]];
        NSString *domainValues = [NSString stringWithFormat:@"%@",Values[4]];
        //Bar_color
        //NSString *barKeys = [NSString stringWithFormat:@"%@",keys[1]];
        ...
        NSArray *keySpaceValue = [keys[7] componentsSeparatedByString:@"\n"];
        ...
        NSArray *descriptionArray = [descriptionValues componentsSeparatedByString:@"\""];
        NSArray *titles_Array = [Values[7] componentsSeparatedByString:@"\""];
        NSArray *submenuValues_Array = [submenuValues componentsSeparatedByString:@"\""];
        NSArray *subdomainValues_Array = [subdomainValues componentsSeparatedByString:@"\""];
        NSArray *domainValues_Array = [subdomainValues componentsSeparatedByString:@"\""];
        NSArray *barValues_Array = [barValues componentsSeparatedByString:@"\""];
        ...
        {
            title_string = [Values[7] stringByAddingPercentEscapesUsingEncoding:NSASCIIStringEncoding];
        }
        if(descriptionArray.count>1)
        {
            descriptio_String = [descriptionArray[1] stringByAddingPercentEscapesUsingEncoding:NSASCIIStringEncoding];
    ...
    //[request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://build.myappbuilder.com/api/subscribers.json?api_key=e8ad6b11300fd6f71d1d20c5fdca5f26&subscriber[firstname]=hhh&subscriber[lastname]=hhh&subscriber[username]=iiii&subscriber[email]=dddd&subscriber[phone]=5555"]]];
